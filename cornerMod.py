    ...
    for i, x in enumerate(xs):
        ...
        if show_titles:
            ...
            if title_fmt is not None:
                ...
                q_05, q_50, q_95 = quantile(x, [0.05, 0.5, 0.95],
                                            weights=weights)
                q_m, q_p = q_50-q_05, q_95-q_50

                print("q_50", q_50, "q_05", q_05, "q_95", q_95)

                #To show to more decimal places, change ".0f" in .format bellow.
                #for the time label, set in titleCounter == 3, more formating is required.
                #an example of the result to 2sf is given in the comments in this section of cornerGR
